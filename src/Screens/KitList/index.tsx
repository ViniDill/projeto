...
import SkeletonKitSearch from "./SkeletonKitSearch";
...
const KitSearch: React.FC = () => {
  ...
  const [selectedKitId, setSelectedKitId] = useState<number | null | string>(
    null
  );
        ...
        <TableContent>
          {listOfKits.map((kit) => (
            <tr key={kit.id}>
              ...
              <td className="Capacity">{`${kit.solar_kit_power} kw`}</td>
              <td className="Price">{"00"}</td>
              <td className="TableIcon">
                <IconBody
                  onClick={() => {
                    navigation("/kit-registration", {
                      state: {
                        kitID: kit.id,
                      },
                    });
        ...
        {listOfKits.map((kit) => (
          <MobileContainer>
            <MobileContent>
              ...
              <Text size="md">{`${kit.solar_kit_power} kw`}</Text>
            </MobileContent>
            <MobileSwitch>
              <IconBody>
                <Switch />
          ...
          <DrawerComponentsContainer>
            <DrawerPadding>
              ...
              <DrawerComponents>
                ...
                <Text size="md">{`${selectedKit.solar_kit_power} kw`}</Text>
              </DrawerComponents>
              <DrawerComponents>
                <Text size="md" bold={true}>
                  {t("kit_search_stats")}
